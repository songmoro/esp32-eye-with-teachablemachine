...
http://192.168.xxx.xxx:81/stream   //       <img src="http://192.168.xxx.xxx:81/stream">
http://192.168.xxx.xxx/capture     //       <img src="http://192.168.xxx.xxx/capture">
...
http://192.168.xxx.xxx/control?ip                      //AP IP, STAIP
...
//WIFI
const char* ssid     = "ITE_3505_1";   //your network SSID
const char* password = "iteadmin3505";   //your network password

//AP
const char* apssid = "ESP32-ONE";
const char* appassword = "12345678";         //AP 8digit
...
//  lcd.print("System init!!");
  ...
  for (int i=0;i<2;i++) {
    ...
    if (WiFi.status() == WL_CONNECTED) {   
      WiFi.softAP((WiFi.localIP().toString()+"_"+(String)apssid).c_str(), appassword);   //SSID IP         
      Serial.println("");
...
<html>
    ...
    <body>
        ...
        //var modelPath = "https://teachablemachine.withgoogle.com/models/iKMZpmqoT/";
